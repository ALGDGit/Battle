 ...
 */
const ZONE_BOSS_DIALOGUE_DRAFTS = {
    native_forest: {
        wormmon: {
            title: "Silk Sentinel",
...
function collectDialogueCharacterIds(event) {
    const ids = [];
    const add = (value) => {
...
export function listBossDialogueCharacterIds(zoneId) {
...
export function getZoneBossDialogue(zoneId, opponentId) {
