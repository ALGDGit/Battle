...
import { EQUIPMENT_CONFIG, INVENTORY_CONFIG, KEY_ITEMS_CONFIG, formatEquipmentEffect, formatCareGainText, getInventoryItemCategories, WILD_WIN_ITEM_DROP_CHANCE, MAX_CONSUMABLE_STACK, pickWildWinDropKey, getWildSpecialDropKeys, getZoneDifficultyTier, countDemonLordIngredients, listOwnedDemonLordIngredientNames, STAGE_ORDER, ZONE_CONFIG, ZONE_ENCOUNTERS, ZONE_EVENTS, ZONE_BOSSES, isZoneUnavailable, EVENT_CHANCE_STEP, EVENT_CHANCE_MAX, EVENT_ROOT_NODE_ID, MAX_LIVES, ENCOUNTER_STAGES, clampCareStat, eventPassesRequirements, filterEligibleZoneEvents, forEachZoneEventChoice, getAlignmentLabel, getDisciplineLabel, getHappinessLabel, getTimeOfDayForZoneLevel, getZoneBackgroundFile, getZoneRunDayOffset, addCombatStatDelta, getBossCombatStats, getCharacterCombatStats, getStageBaseStats, getTableCombatStats, getWildCombatStats, getEncounterEntryStats, findZoneEncounterEntry, getZoneEventNode, getZoneRunRules, getZoneStagePool, getZoneEncounterStageWeights, isIndoorZone, listZoneBossOpponentIds, listBossDialogueCharacterIds, filterDropsForOpponent, listZoneEncounterIds, pickWeightedEncounterId, pickWeightedIndex, pickWeightedZoneEvent, resolveConditionalText, getZoneBossDialogue, TIME_OF_DAY_ICONS, TIME_OF_DAY_LABELS, } from "./constants.js";
import { applyStarterAttributes, resetRunState, state } from "./state.js";
import { getAttackProjectile, getCriticalChance, getStageKey, hasTypeAdvantage, normalizeBattleType, } from "./combat/projectiles.js";
import { resolveUniqueEffect, } from "./combat/uniqueEffects.js";
import { getSeenZoneContent, bumpBgCalendarDay, readBgCalendarDay, isZoneBossDefeated, isZoneUnlocked, markBossOpponentDefeated, markSeenZoneEntry, markZoneBossDefeated, readDefeatedBossOpponentIds, readUnlockedZoneIds, resetZoneProgressForNewGame, unlockZoneIds, } from "./persist/zoneProgress.js";
...
const { singlePlayerButton, arenaModeButton, vpetUploadButton, exitButton, mainMenu, arenaMenu, arenaPlayerList, arenaOpponentList, arenaStartButton, arenaBackButton, characterMenu, playerList, startGameButton, backButton, hubMenu, hubHouseButton, hubPathButton, hubBackButton, hubFinalChallengeButton, zoneMenu, zoneMap, zoneBackButton, zoneInfoMenu, zoneInfoTitle, zoneInfoSubtitle, zoneInfoEncountersHeading, zoneInfoEventsHeading, zoneInfoBossesHeading, zoneInfoEncounters, zoneInfoEvents, zoneInfoBosses, zoneInfoBackButton, actionMenu, actionBackButton, feedButton, trainButton, equipmentButton, keyItemsButton, weightCounter, livesRow, meatCount, disciplineCounter, happinessCounter, alignmentCounter, attrHpCounter, attrAttackCounter, attrDefenseCounter, attrSpeedCounter, attrIntelligenceCounter, winRateDisplay, caretakerSprite, caretakerName, caretakerStage, caretakerTypeIcon, equipmentStatus, feedMenu, feedBackButton, feedFilters, feedItemDesc, feedMeatButton, feedItemList, feedSpriteSlot, feedFoodSprite, feedFoodContainer, equipmentMenu, equipmentBackButton, equipmentItemDesc, equipmentSpriteSlot, equipmentPreviewImg, keyItemsMenu, keyItemsDesc, keyItemsBackButton, keyItemsList, keyItemsEmpty, itemHoverTooltip, equipWoodenSwordButton, woodenSwordStatus, equipCarapaceArmorButton, carapaceArmorStatus, equipCyberpartsButton, cyberpartsStatus, equipBaseballBatButton, baseballBatStatus, equipKaisersGogglesButton, kaisersGogglesStatus, equipHardScaleButton, hardScaleStatus, equipNarwhalHornButton, narwhalHornStatus, equipCursedHornButton, cursedHornStatus, equipMightyHornButton, mightyHornStatus, equipBlazingArmorButton, blazingArmorStatus, equipAncientRelicButton, ancientRelicStatus, equipCatGlovesButton, catGlovesStatus, equipDespairClawButton, despairClawStatus, equipJumboCannonButton, jumboCannonStatus, equipCyberSwordButton, cyberSwordStatus, equipArsenalButton, arsenalStatus, equipAncientTabletButton, ancientTabletStatus, equipInfiniteHeadsButton, infiniteHeadsStatus, equipFurCoatButton, furCoatStatus, equipInfinityGauntletButton, infinityGauntletStatus, equipShellArmorButton, shellArmorStatus, equipGarurumonCoatButton, garurumonCoatStatus, equipGearRingButton, gearRingStatus, equipSacredCollarButton, sacredCollarStatus, equipCockatriceFeatherButton, cockatriceFeatherStatus, equipGaogamonMachineGunButton, gaogamonMachineGunStatus, equipPoisonedDaggerButton, poisonedDaggerStatus, equipNinjaStarsButton, ninjaStarsStatus, equipBoxingGlovesButton, boxingGlovesStatus, equipChainsawButton, chainsawStatus, equipMetalCoatButton, metalCoatStatus, equipStingerCannonButton, stingerCannonStatus, equipDarkLanceButton, darkLanceStatus, equipVDramonHornButton, vDramonHornStatus, equipLilimonPetalsButton, lilimonPetalsStatus, equipAlienPistolButton, alienPistolStatus, equipThorsHammerButton, thorsHammerStatus, equipGrowmonFangButton, growmonFangStatus, equipHedgehogShellButton, hedgehogShellStatus, trainMenu, trainBackButton, trainFill, trainStatus, trainRetryButton, trainSpriteSlot, trainBag, evolutionScreen, evolutionOld, evolutionNew, evolutionMessage, evolutionContinue, gameoverScreen, gameoverSprite, gameoverContinue, congratsScreen, congratsSprite, congratsContinue, eventScreen, eventTitle, eventZoneLabel, eventPanel, zoneSceneFade, eventSpeakerSprite, eventSpeakerName, eventText, eventChoices, eventPostActions, eventContinueButton, eventFeedButton, eventRetreatButton, battleScreen, battleTitle, fastCombatButton, zoneLevelLabel, battleBackButton, battleDefaultActions, zonePostBattleActions, zoneContinueButton, zoneFeedButton, zoneRetreatButton, zoneBattleItems, zoneEventItems, finalChallengeModal, finalChallengeConfirmButton, finalChallengeCancelButton, actionBackModal, actionBackConfirmButton, actionBackCancelButton, endRunModal, endRunTitle, endRunMessage, endRunConfirmButton, dropModal, dropModalTitle, dropModalMessage, dropModalList, dropModalConfirmButton, battlePlayerName, battleOpponentName, battlePlayerHp, battleOpponentHp, battleLog, battlePlayerSprite, battleOpponentSprite, battleField, playerStatusAsleep, playerStatusPoisoned, playerStatusConfused, playerStatusDemoralized, playerStatusSilenced, playerStatusBlinded, playerStatusInverted, playerStatusBurned, playerStatusVampirism, playerStatusThorns, playerStatusReflector, playerStatusImmune, playerStatusReckless, playerStatusPositivePole, playerStatusCursed, playerStatusMarked, playerStatusDrained, playerStatusBound, playerStatusNegativePole, playerStatusDeepWound, playerStatusInfatuated, playerStatusFortified, playerStatusProtected, playerStatusSwift, playerStatusFocused, playerStatusWeak, playerStatusExposed, playerStatusSlow, playerStatusDistracted, opponentStatusAsleep, opponentStatusPoisoned, opponentStatusConfused, opponentStatusDemoralized, opponentStatusSilenced, opponentStatusBlinded, opponentStatusInverted, opponentStatusBurned, opponentStatusVampirism, opponentStatusThorns, opponentStatusReflector, opponentStatusImmune, opponentStatusReckless, opponentStatusPositivePole, opponentStatusCursed, opponentStatusMarked, opponentStatusDrained, opponentStatusBound, opponentStatusNegativePole, opponentStatusDeepWound, opponentStatusInfatuated, opponentStatusFortified, opponentStatusProtected, opponentStatusSwift, opponentStatusFocused, opponentStatusWeak, opponentStatusExposed, opponentStatusSlow, opponentStatusDistracted, } = dom;
const inventoryUi = {};
const equipmentUi = {
...
zoneMap.addEventListener("click", (event) => {
    ...
    const infoButton = target.closest(".zone-info-button[data-zone]");
    if (infoButton) {
    ...
    const zoneButton = target.closest(".zone-spot[data-zone]");
    if (!zoneButton) {
        return;
    }
...
function showFinalChallengePopup() {
...
function showEndRunPopup(unlockedNames) {
    return new Promise((resolve) => {
        const previousFocused = document.activeElement instanceof HTMLElement ? document.activeElement : null;
        const close = () => {
        ...
        const unlockLine = unlockedNames.length > 0
...
let pendingDropNotices = [];
function resolveDropIcon(kind, key) {
...
function queueDropNotice(name, amount, asset) {
...
function takePendingDropNotices() {
    const notices = pendingDropNotices;
    pendingDropNotices = [];
    return notices;
}
function showDropPopup(notices, sourceName) {
    return new Promise((resolve) => {
        if (!notices.length) {
            resolve();
            return;
...
function resumeZoneAfterEvolution() {
    ...
    if (battlePlayerSprite && state.player?.spriteFramesPath) {
        ...
        battlePlayerSprite.append(createBattleSprite(state.player.spriteFramesPath, state.player.name, true, "player"));
    }
...
function bindInventoryFeedActions() {
    INVENTORY_CONFIG.forEach((item) => {
        ...
        button.addEventListener("click", () => {
            const context = feedReturnContext === "event"
                ? "event"
...
let feedItemFilter = "all";
function getFeedItemCategories(itemKey) {
    if (itemKey === "meat") {
        return ["other"];
    }
...
function matchesFeedItemFilter(itemKey) {
...
function showItemHoverTooltip(anchor, text) {
...
function bindItemHoverDescription(button, text) {
    const desc = String(text || "").trim();
...
function normalizeCharacter(character) {
    ...
    const hasStandard = attacks.some((attack) => attack.name &&
...
let arenaPlayerSelection = null;
let arenaOpponentSelection = null;
...
function createArenaCharacterCard(character, scope) {
...
function createEggCard(egg) {
    ...
    card.addEventListener("click", () => {
        if (!egg.hatchedCharacter) {
            const sprite = card.querySelector(".character-sprite");
            if (!sprite) {
                return;
            }
...
function startSpritePreview() {
    ...
    spriteTickerId = window.setInterval(() => {
        const sprites = document.querySelectorAll('#character-menu .character-sprite, #arena-menu .character-sprite, #action-menu .character-sprite[data-preview-scope="caretaker"]');
        if (sprites.length === 0) {
            return;
        }
...
function readFastCombatSetting() {
    try {
...
function writeFastCombatSetting(on) {
    try {
...
function startBattle() {
    ...
    if (state.eventBattleOverride) {
        const forced = state.characters.find((char) => String(char.id) === String(state.eventBattleOverride?.opponentId));
        state.opponent = forced || state.characters[0] || {};
        pendingZoneOpponent = null;
    }
    else if (state.zoneBossFight) {
        const forced = state.characters.find((char) => String(char.id) === String(state.zoneBossFight?.opponentId));
        state.opponent = forced || state.characters[0] || {};
        pendingZoneOpponent = null;
    }
    ...
    state.battle = {
        ...
        specialBonus: (activeConsumable === "yellow_pear" ? 0.2 : 0) +
    ...
    if (activeConsumable === "storm_cloud" ||
    ...
    battlePlayerSprite.append(createBattleSprite(state.player.spriteFramesPath, state.player.name, true, "player"));
    battleOpponentSprite.append(createBattleSprite(state.opponent.spriteFramesPath, state.opponent.name, false, "opponent"));
    battleLog.innerHTML = "";
...
function updateBattleBackground() {
    ...
    let stage = isStage(state.player.stage) ? state.player.stage : "Child";
...
function getStatProcChance(statValue) {
...
function getOpponentCombatStats(opponent) {
    ...
    if (zoneId && encounterId && zoneId in ZONE_ENCOUNTERS) {
        const config = ZONE_ENCOUNTERS[zoneId];
...
function getCombatStats(role) {
    const base = role === "player"
        ? state.battle?.playerStats || getPlayerCombatStats()
...
function applyCursedEquipmentInversion(role, stats) {
...
function updateZoneUnlockUi() {
    ...
    zoneMap.querySelectorAll(".zone-spot[data-zone]").forEach((button) => {
    ...
    zoneMap.querySelectorAll(".zone-info-button[data-zone]").forEach((button) => {
        const id = button.dataset.zone || "";
        const unavailable = isZoneUnavailable(id);
        const isOpen = !unavailable && unlocked.has(id);
        button.disabled = !isOpen;
...
function getZoneEncounterIds(zoneId) {
...
function getZoneBossOpponentIds(zoneId) {
...
function getZoneEncounterStats(zoneId, encounterId) {
    if (!(zoneId in ZONE_ENCOUNTERS)) {
        return null;
    }
    const config = ZONE_ENCOUNTERS[zoneId];
...
function getZoneBossEntry(zoneId, opponentId) {
    if (!(zoneId in ZONE_BOSSES)) {
        return null;
    }
    const boss = ZONE_BOSSES[zoneId];
...
function formatDropsLine(drops) {
    if (!drops?.length) {
        return "Drops: —";
    }
    const parts = drops.map((drop) => {
        const name = resolveDropDisplayName(drop);
        const amount = (drop.kind === "inventory" || drop.kind === "meat") && Number(drop.amount || 1) > 1
...
function formatWildEncounterDropsLine(zoneId, opponentId) {
...
function getZoneEncounterDrops(zoneId, opponentId) {
    if (!(zoneId in ZONE_ENCOUNTERS)) {
        return [];
    }
    const config = ZONE_ENCOUNTERS[zoneId];
...
function resolveEventFightStats(outcome) {
...
function getEventFightPreview(eventDef) {
    let stats = null;
    const drops = [];
...
function fillZoneInfoList(container, heading, title, cards) {
    container.innerHTML = "";
...
function openZoneInfoMenu(zoneId) {
    ...
    const eventCards = eventDefs.map((eventDef) => {
        const speaker = state.characters.find((char) => String(char.id) === String(eventDef.speakerId));
    ...
    fillZoneInfoList(zoneInfoEncounters, zoneInfoEncountersHeading, "Encounters", encounterCards);
...
function getZoneBackgroundUrl(zoneId = state.currentZone) {
    if (!zoneId) {
        return "";
    }
...
function preloadCssBackground(cssUrl) {
...
function rememberZoneBackgroundUrl(cssUrl) {
    lastZoneBackgroundUrl = cssUrl;
}
function playZoneBackgroundTransition(then) {
...
function getZoneTimeOfDay(zoneId = state.currentZone) {
    if (!zoneId || isIndoorZone(zoneId) || state.zoneLevel <= 0) {
        return null;
    }
    return getTimeOfDayForZoneLevel(state.zoneLevel);
}
function renderZoneProgressLabel(target, suffix = "") {
...
function tryStartZoneOpeningEvent(zoneId) {
    const rules = getZoneRunRules(zoneId);
    if (!rules.startEvent) {
        return false;
    }
    ...
    const forced = events.filter((event) => event.id === rules.startEvent &&
...
function getZoneEncounterExcludeIds() {
...
function isResolvedStoryZoneEvent() {
...
function getZoneEventChanceStep(zoneId = state.currentZone) {
    const rules = getZoneRunRules(zoneId);
    return typeof rules.eventChanceStep === "number" ? rules.eventChanceStep : EVENT_CHANCE_STEP;
}
function getZoneEventChanceMax(zoneId = state.currentZone) {
    const rules = getZoneRunRules(zoneId);
...
function beginZoneEncounter() {
    ...
    if (pendingQueuedEventId) {
        ...
        const queued = (ZONE_EVENTS[state.currentZone] || []).find((event) => event.id === queuedId);
        if (queued) {
            startForcedZoneEvent(queued);
            return;
        }
    }
    const boss = state.currentZone in ZONE_BOSSES
        ? ZONE_BOSSES[state.currentZone]
        : null;
    if (boss &&
...
function opponentMayTryFlee(player, opponent) {
    if (!player || !opponent) {
        return false;
    }
...
function playerMayTryFlee(player, opponent) {
    if (!player || !opponent) {
        return false;
    }
    const playerStage = getStageIndex(player.stage);
...
function showOpponentFleePrompt(opponent) {
    pendingZoneOpponent = opponent;
    ...
    if (opponent?.spriteFramesPath) {
        eventSpeakerSprite.append(createBattleSprite(opponent.spriteFramesPath, opponent.name, false, "event"));
    }
...
function showPlayerFleePrompt(opponent) {
    pendingZoneOpponent = opponent;
    if (state.currentZone && opponent?.id) {
        markSeenZoneEntry(state.currentZone, "encounters", String(opponent.id));
    }
...
function beginZoneBossDialogue(boss) {
    const ids = listZoneBossOpponentIds(boss);
...
function startZoneBossFight(boss, forcedOpponentId) {
    const ids = listZoneBossOpponentIds(boss);
    const forced = forcedOpponentId ? String(forcedOpponentId) : "";
    const opponentId = (forced ? forced : null) ||
    ...
    const opponent = state.characters.find((char) => String(char.id) === String(opponentId)) ||
        state.characters[0];
    if (opponent) {
...
function getZoneName(zoneId = state.currentZone) {
...
function isBossEncounterBlockingRetreat() {
...
function showPreBattlePrep(opponent, kind) {
    pendingZoneOpponent = opponent;
    zonePreBattle = { active: true, itemUsed: false, kind };
    if (state.currentZone && opponent?.id) {
        markSeenZoneEntry(state.currentZone, kind === "boss" ? "bosses" : "encounters", String(opponent.id));
    }
    endBattle();
    battleScreen.classList.add("hidden");
    hideZonePostBattleActions();
...
function showZonePostBattleActions(playerWon) {
    battleDefaultActions.classList.add("hidden");
...
function applyItemCareGains(gains) {
...
function useInventoryItem(itemKey, context = "adventure") {
    const item = INVENTORY_CONFIG.find((entry) => entry.key === itemKey);
    if (!item) {
        return false;
    }
    ...
    if (item.useEffect === "attributes") {
        ...
        ["hp", "attack", "defense", "speed", "intelligence"].forEach((stat) => {
    ...
    if (item.useEffect === "xAntibody") {
        ...
        const inherited = Array.isArray(target.evolvesTo) && target.evolvesTo.length
            ? target.evolvesTo
            : previous?.evolvesTo;
...
function getEventSpeakerImg() {
    return eventSpeakerSprite?.querySelector?.(".character-sprite") || null;
}
function startEventSpeakerAnim(mood = "idle") {
    stopEventSpeakerAnim();
...
function inferEventChoiceMood(outcomes) {
    let happy = false;
    let angry = false;
...
function buildEventStatSnapshot() {
    const attrs = state.attributes || {
        hp: 0,
        attack: 0,
        defense: 0,
    ...
    const currentHp = typeof state.zoneRunHp === "number" ? Math.max(0, state.zoneRunHp) : maxHp;
    ...
    return {
        ...
        consumedEvents: Object.fromEntries((state.consumedEventIds || []).map((id) => [String(id), 1])),
        bannedEvents: Object.fromEntries(readBannedEventIds().map((id) => [String(id), 1])),
        eventWins: { ...readAllEventWinCounts() },
        defeatedBossOpponents: Object.fromEntries(readDefeatedBossOpponentIds().map((id) => [String(id), 1])),
        unlockedZones: Object.fromEntries(readUnlockedZoneIds().map((id) => [String(id), 1])),
...
function choicePassesRequirements(choice, snapshot = buildEventStatSnapshot()) {
...
function consumeZoneEvent(eventId) {
...
function resolveEventEndingRepeatable(eventDef, choice, outcomeOverride) {
...
function finishActiveEvent(options) {
    ...
    const canRepeat = resolveEventEndingRepeatable(eventDef, options?.choice, options?.repeatable);
...
function findActiveZoneEventDefinition() {
...
function setEventSpeaker(speakerId) {
    const speaker = state.characters.find((char) => String(char.id) === String(speakerId || "")) || null;
    eventSpeakerSprite.innerHTML = "";
    if (speaker?.spriteFramesPath) {
        eventSpeakerSprite.append(createBattleSprite(speaker.spriteFramesPath, speaker.name, false, "event"));
    }
...
function applyEventSideOutcomes(outcomes) {
    (outcomes || []).forEach((outcome) => {
        if (!outcome || !outcome.type) {
            return;
        }
        ...
        if (outcome.type === "damagePercent") {
            ...
            const amount = percent <= 0 ? 0 : Math.max(1, Math.ceil((maxHp * percent) / 100));
            state.zoneRunHp = Math.max(minHp, current - amount);
            syncAdventureHpDisplay();
        }
    });
}
function stealRandomInventoryItemForEvent() {
    if (!state.activeEvent) {
        return false;
    }
    const owned = INVENTORY_CONFIG.map((entry) => entry.key).filter((key) => (Number(state.inventory[key]) || 0) > 0);
    if (owned.length === 0) {
...
function returnStolenItemForEvent() {
...
function showZoneEventDialogue(eventDef, nodeId = EVENT_ROOT_NODE_ID) {
    ...
    if (targetNodeId !== EVENT_ROOT_NODE_ID &&
    ...
    const willEnter = Boolean(state.activeEvent && !applied.includes(targetNodeId) && (targetNode.enterOutcomes || []).length);
    snapshot = buildEventStatSnapshot();
    eventTitle.textContent = eventDef.title || "Event";
    updateEventZoneLabel();
    eventPanel.style.backgroundImage = getZoneBackgroundUrl();
    setEventSpeaker(targetNode.speakerId || eventDef.speakerId);
    eventText.textContent = resolveConditionalText(targetNode.text || "", targetNode.textVariants, snapshot);
...
function startZoneEvent(events) {
...
function startForcedZoneEvent(eventDef) {
    state.zoneEventChance = 0;
...
function ownedHealItemKey(inventory = state.inventory) {
    const entry = INVENTORY_CONFIG.find((item) => isHealInventoryItem(item) && (Number(inventory[item.key]) || 0) > 0);
    return entry?.key || null;
}
function isWeightInventoryItem(item) {
    return item.useEffect === "weight";
}
function ownedWeightItemKey(inventory = state.inventory) {
    const entry = INVENTORY_CONFIG.find((item) => isWeightInventoryItem(item) && (Number(inventory[item.key]) || 0) > 0);
    return entry?.key || null;
}
function hasWeightFood(inventory = state.inventory, meat = state.meat) {
    return (Number(meat) || 0) > 0 || Boolean(ownedWeightItemKey(inventory));
}
function isStatBuffInventoryItem(item) {
    return getInventoryItemCategories(item).includes("statBuff");
}
function ownedStatBuffItemKey(inventory = state.inventory) {
    const entry = INVENTORY_CONFIG.find((item) => isStatBuffInventoryItem(item) && (Number(inventory[item.key]) || 0) > 0);
    return entry?.key || null;
}
function applyOrQueueOpponentCombatEffects(effects) {
...
function formatOpponentCombatEffectList(effects) {
    const labels = {
        exposed: "exposed",
        slow: "slowed",
        weak: "weakened",
...
function applyOrQueuePlayerCombatEffects(effects) {
    const live = Boolean(state.battle && state.battle.ended !== true);
    if (live) {
...
function formatPlayerCombatEffectList(effects) {
    const labels = {
        vampirism: "Vampirism",
        thorns: "Thorns",
        reflector: "Reflector",
...
function grantInventoryItem(key, amount = 1, label, silent = false) {
    if (!key) {
        return 0;
    }
...
function grantKeyItem(key, amount = 1, label, silent = false) {
    if (!key) {
        return 0;
    }
    const qty = Number(amount) || 0;
...
function grantEquipmentItem(key, label, silent = false) {
    if (!key) {
        return false;
    }
...
function attemptEnemyDrops(drops) {
    if (!drops?.length) {
        return;
    }
    drops.forEach((drop) => {
...
function attemptWildWinItemDrop() {
    ...
    const specialItemKeys = getWildSpecialDropKeys(state.currentZone, state.opponent?.id ? String(state.opponent.id) : null).filter((key) => {
        if (key === "meat") {
            return true;
        }
...
function resolveZoneEventChoice(choice) {
    ...
    let pendingBossFightOpponentId = null;
    let pendingEndRun = false;
    let pendingStatCheck = null;
    const unlockedThisChoice = [];
    let repeatOverride;
    ...
    (choice.outcomes || []).forEach((outcome) => {
        ...
        if (outcome.type === "stealRandomInventoryItem") {
            ...
            if (stole) {
                autoMessages.push(`Koemon stole your ${state.activeEvent?.stolenItemLabel || "item"}!`);
            }
            else {
        ...
        if (outcome.type === "statCheck") {
            ...
            if (mode === "critical") {
                ...
                pendingStatCheck = { passed, chance };
                if (passed) {
                    autoMessages.push(`Check success! (${Math.round(chance * 100)}% — ${statKey} ${statValue})`);
                }
                else {
                    autoMessages.push(`Check failed… (${Math.round(chance * 100)}% — ${statKey} ${statValue})`);
                }
            }
            return;
        }
        ...
        if (outcome.type === "spendAnyItem") {
            const spentKey = INVENTORY_CONFIG.map((entry) => entry.key).find((key) => (Number(state.inventory[key]) || 0) > 0);
            if (!spentKey) {
        ...
        if (outcome.type === "unlockZones") {
            ...
            const namesForPopup = (unlocked.length > 0 ? unlocked : requested).map((id) => ZONE_CONFIG.find((zone) => zone.id === id)?.name || id);
    ...
    if (pendingBossFight) {
        ...
        closeEventScreen();
        if (pending) {
            startZoneBossFight(pending.boss, pendingBossFightOpponentId || pending.opponentId);
        }
        return;
    }
    if (pendingStatCheck) {
        ...
        if (!pendingStatCheck.passed) {
            const failText = flavorMessages.length > 0
                ? flavorMessages.join(" ")
    ...
    if (pendingFight) {
        ...
        const opponent = state.characters.find((char) => String(char.id) === String(pendingFight?.opponentId));
        if (!opponent) {
        ...
        state.eventBattleOverride = {
            ...
            reputationOnWin: typeof pendingFight.reputationOnWin === "number"
...
function continueZoneRun() {
    ...
    state.zoneLevel += 1;
    if (!fromStoryEvent) {
        state.zoneEventChance = Math.min(getZoneEventChanceMax(), state.zoneEventChance + getZoneEventChanceStep());
    }
    state.opponent = null;
    playZoneBackgroundTransition(() => {
        endBattle();
...
let feedReturnContext = "home";
function openFeedMenu(returnTo = "home") {
...
function closeFeedMenu() {
    ...
    if (returnTo === "battle" && state.currentZone) {
        battleScreen.classList.remove("hidden");
        const canContinue = Boolean(state.battle?.ended) &&
...
function updateLivesDisplay() {
    ...
    const hearts = livesRow.querySelectorAll(".life-heart");
    hearts.forEach((heart, index) => {
        heart.setAttribute("src", index < state.lives ? "data/ui/heart_full.png" : "data/ui/heart_empty.png");
...
function getHomeTrainBoost() {
    return Math.max(0, Math.min(HOME_TRAIN_BOOST_MAX, Math.floor(Number(state.homeTrainBoost) || 0)));
}
function hasTrainingManual() {
...
function updateMeatDisplay() {
    ...
    const meatVisible = (state.meat ?? 0) > 0 && feedReturnContext === "home" && matchesFeedItemFilter("meat");
...
function updateAttributes() {
    ...
    renderAttributeLine(attrIntelligenceCounter, "Intelligence", attrs.intelligence, bonuses.intelligence || 0, isTemporaryStatBuffed("intelligence"), train);
}
function isTemporaryStatBuffed(stat) {
    return Boolean(state.gearUpActive ||
        state.gearUpPending ||
        state.zoneRunBuffs?.[stat] ||
        state.zoneRunBuffsPending?.[stat]);
}
function renderAttributeLine(el, label, base, gear, tempBuffed, trainBoost = 0) {
    if (!el) {
        return;
    }
...
function applyEvolutionStatGains(previous, evolved) {
    ...
    const minHpGain = Math.max(0, getStageBaseStats(evolved.stage).hp - getStageBaseStats(previous?.stage).hp);
...
function applyEvolutionZoneRunHp(previousHp, previousMaxHp) {
...
function syncEvolvedBattleHp(currentHp) {
    if (!state.battle) {
        return;
    }
    state.battle.playerStats = { ...getPlayerCombatStats() };
...
function updateInventory() {
    INVENTORY_CONFIG.forEach((item) => {
        ...
        const total = Math.min(MAX_CONSUMABLE_STACK, Math.max(0, Number(state.inventory[item.key]) || 0));
...
function updateKeyItems() {
    ...
    const extraKeys = Object.keys(state.keyItems).filter((key) => !known.has(key) && (state.keyItems[key] || 0) > 0);
    if (keyItemsEmpty) {
    ...
    owned.forEach((item) => {
        ...
        bindItemHoverDescription(button, canUse ? `${item.label} (Tap to combine!)` : item.label);
        if (canUse) {
            button.addEventListener("click", () => {
...
function keyItemUseAvailable(item) {
    const action = item.onUse;
    if (!action || action.type !== "combineIntoInventory") {
        return false;
    }
    return (action.requireKeyItems || []).every((key) => (Number(state.keyItems[key]) || 0) > 0);
}
function tryUseKeyItem(itemKey) {
...
function renderWinRate() {
    const rate = state.stats.battles === 0
        ? 0
...
function saveStats() {
    window.localStorage.setItem("battleStats", JSON.stringify({
...
function getEggSelectionOptions() {
...
function getBabyICharacters() {
    return state.characters
        .filter((char) => char.stage === "Baby I")
        .slice()
        .sort((a, b) => (a.name || "").localeCompare(b.name || ""));
}
function getOrCreateEggBabyMap() {
    const babies = getBabyICharacters();
    if (babies.length === 0) {
        return {};
    }
...
function readEggBabyMap() {
    try {
        ...
        return Object.fromEntries(Object.entries(parsed).map(([eggId, babyId]) => [String(eggId), String(babyId)]));
    }
    catch (error) {
        console.error(error);
        return {};
...
function writeEggBabyMap(map) {
    window.localStorage.setItem(EGG_BABY_MAP_KEY, JSON.stringify(map));
}
function pickBestMatchingBaby(egg, candidates) {
...
function getNameMatchScore(eggKey, babyKey) {
    if (!eggKey || !babyKey) {
        return 0;
    }
    if (eggKey === babyKey) {
...
function getArenaAvailableCharacters() {
...
function markHistoryCharacterPlayed(character) {
...
function writeHistoryPlayedIds(ids) {
...
function pickRandomOpponent() {
    ...
    let pool = state.characters.filter((char) => char.stage === STAGE_ORDER[targetIndex]);
    if (pool.length === 0) {
...
function pickZoneOpponent(zoneId) {
    const config = zoneId in ZONE_ENCOUNTERS
        ? ZONE_ENCOUNTERS[zoneId]
        : null;
    if (!config) {
        return state.characters[0] || {};
    }
...
function playBattleIntro() {
    return new Promise((resolve) => {
        const battleSprites = document.querySelectorAll(".battle-sprite-frame .character-sprite");
...
async function runBattleTurn() {
    ...
    if (attackerStatus?.asleep) {
        const bossSleepsUntilTimer = attackerRole === "opponent" && isBossBattle() && Boolean(state.battle.bossTimers);
    ...
    if (hasBattleStatus(defenderRole, "bound") ||
    ...
    if (dodged) {
        ...
        const reflected = hasBattleStatus(defenderRole, "reflector") && Math.random() < 0.33;
        if (reflected) {
            const dealt = dealCombatDamage(attackerRole, damage, true);
            logBattle(`${defenderCharacter?.name || "Foe"} reflects the attack back for ${dealt} damage!`);
            if (attack.heal) {
...
function resolveBattleIfFinished() {
...
function finalizeTurn(nextRole) {
    ...
    tickBossRecoveries(state.battle.turn);
...
function ensureBossTimers() {
    ...
    return state.battle.bossTimers;
}
function rollBossStatusTurns() {
    return Math.random() < 0.5 ? 2 : 3;
}
function rollBossDebuffTurns() {
    return Math.random() < 0.5 ? 3 : 4;
}
function armBossStatusTimer(role, key) {
    if (role !== "opponent") {
        return;
    }
...
function armBossDebuffTimer(role, stat) {
    if (role !== "opponent") {
        return;
    }
    const timers = ensureBossTimers();
...
function tickBossRecoveries(finishedRole) {
    ...
    Object.keys(timers.status).forEach((key) => {
...
function getBattleStatMods(role) {
    if (!state.battle.statMods) {
...
function hasBattleStatus(role, key) {
    return Boolean(state.battle?.status?.[role]?.[key]);
}
function formatZoneStatLabel(stat) {
    if (stat === "attack") {
        return "Attack";
    }
    if (stat === "defense") {
...
function applyRandomZoneDebuffs(count) {
    const stats = ["attack", "defense", "speed", "intelligence"];
...
function applyZoneRunBuffsToBattle() {
    ...
    const labels = [];
    ["attack", "defense", "speed", "intelligence"].forEach((stat) => {
        if (buffs[stat]) {
...
function applyPlayerStartDebuffs(debuffs) {
    if (!state.battle) {
        return;
    }
...
function applyOpponentStartBuffs(buffs) {
    if (!state.battle?.statMods) {
        return;
    }
    const list = buffs === true ? ["fortified", "protected", "swift", "focused"] : buffs;
    list.forEach((buff) => {
...
function resolveStatModEffect(effect) {
...
function applyBattleStatMods(role, stats) {
    const mods = getEffectiveStatMods(role);
    const scale = (value, buffed, debuffed) => {
        let next = value;
        if (buffed) {
...
function getEffectiveStatMods(role) {
    ...
    const channel = (rawBuff, rawDebuff) => {
...
function getSleepWakeChance(sleepTurns) {
    if (sleepTurns <= 1) {
        return 0.1;
    }
    if (sleepTurns === 2) {
...
function dealCombatDamage(role, amount, isAttackDamage) {
    if (!state.battle) {
        return 0;
    }
...
function applyBattleEffect(role, effect, explicitChance, guaranteed = false) {
...
function applyUniqueEffect(role, effect, explicitChance, guaranteed = false) {
    if (!state.battle) {
        return;
    }
...
function clearNegativeStatuses(role) {
    const target = state.battle?.status?.[role];
    if (!target) {
        return false;
    }
    const hadStatus = Boolean(target.asleep ||
        target.confused ||
        target.poisoned ||
        target.demoralized ||
        target.silenced ||
...
function clearStatDebuffs(role) {
    const mods = state.battle?.statMods?.[role];
    if (!mods?.debuff) {
        return false;
    }
    const hadDebuff = Boolean(mods.debuff.attack || mods.debuff.defense || mods.debuff.speed || mods.debuff.intelligence);
...
function applyStatMod(role, effect, explicitChance) {
    if (!state.battle) {
        return;
    }
...
function hasDebuffImmunity(stat) {
    const gear = getEquippedGear();
...
function normalizeStatusImmunityKey(status) {
...
function applyStatus(defenderRole, status, explicitChance, guaranteed = false) {
    if (!status || status === "none" || !state.battle) {
        return;
    }
    const defenderName = defenderRole === "player" ? state.player?.name : state.opponent?.name;
    ...
    if (defenderRole === "player") {
        ...
        if (gear?.statusImmunities?.some((entry) => normalizeStatusImmunityKey(String(entry)) === statusKey)) {
...
function applySelfDamage(role, attacker) {
...
function applyVampirismHeal(role, attacker, dealt) {
...
function applyUniqueThorns(defenderRole, attackerRole, dealt, defenderName) {
...
function applyDeepWoundOnDodge(role, character) {
    ...
    logBattle(`${character?.name || "Foe"}'s deep wound tears open for ${dealt} damage!`);
    if (role === "player" &&
        state.battle.playerHp <= 0 &&
        state.battle.adrenalineReady?.player) {
        state.battle.adrenalineReady.player = false;
...
function getBlindedDodgeChance(attackerRole, baseDodge) {
...
function setStatusIcon(el, visible) {
    if (el) {
...
function createProjectileVisual(attacker, attack) {
    const src = getAttackProjectile(attacker, attack);
    const stageKey = getStageKey(attacker.stage);
    const isPowerful = attack?.name === "final attack" ||
...
function chooseAttack(attackerRole, attacker, defender) {
    ...
    if (state.battle.forceSpecial === attackerRole && !blockSpecial) {
        ...
        state.activeConsumable = null;
        updateEquipmentStatus();
        return (getSpecialAttack(attacker) || {
            name: "special attack",
...
function getSpecialStatus(attacker) {
    const fromField = String(attacker.specialStatus || "").trim();
    if (fromField && fromField !== "none") {
        return fromField;
    }
    const special = (attacker.attacks || []).find((attack) => String(attack?.name || "").toLowerCase() === "special attack");
...
function randomStatus() {
    const options = ["poison", "sleep", "confuse", "demoralize"];
    return options[Math.floor(Math.random() * options.length)];
}
function playerMeetsEvolutionRequirements() {
    if (!state.player) {
        return false;
    }
...
function pickBabyIiChildEvolution() {
    ...
    const findChild = (id) => state.characters.find((char) => String(char.id) === id && char.stage === "Child") || null;
    return findChild(primaryId) || findChild(fallbackId);
}
/** Child → Adult by care meters (Agumon / Betamon lines). */
function pickChildAdultEvolution() {
    const findAdult = (id) => state.characters.find((char) => String(char.id) === id && char.stage === "Adult") || null;
    const playerId = String(state.player?.id || "");
...
function alreadyXAntibodyForm(character) {
    const id = String(character?.id || "");
    return Boolean(id) && /_x$/i.test(id);
}
function findXAntibodyForm(character) {
    if (!character) {
        return null;
    }
    const id = String(character.id || "");
    ...
    const byId = (candidateId) => {
        const sameStage = state.characters.find((entry) => String(entry.id) === candidateId && (!stage || entry.stage === stage));
        if (sameStage) {
            return sameStage;
        }
    ...
    const aliases = { tyranomon: "tyrannomon_x" };
    if (aliases[id]) {
    ...
    return (state.characters.find((entry) => nameTargets.has(String(entry.name || "").trim()) &&
        (!stage || entry.stage === stage)) || null);
}
/** Feed-triggered Ultimate (e.g. Monzaemon + Nightmare Burrito). */
let pendingFeedUltimateId = null;
/**
 ...
 */
function getPerfectUltimateTargetId() {
...
function pickPerfectUltimateEvolution() {
    const targetId = getPerfectUltimateTargetId();
    if (!targetId) {
        return null;
    }
    return (state.characters.find((char) => String(char.id) === targetId && char.stage === "Ultimate") || null);
}
function performEvolution() {
    ...
    if (state.player.stage === "Baby II" && nextStage === "Child") {
        ...
        const pool = state.characters.filter((char) => allowed.has(String(char.id || "")) && char.stage === nextStage);
        if (pool.length === 0) {
            return false;
        }
    ...
    const previousHp = state.currentZone && typeof state.zoneRunHp === "number"
        ? state.zoneRunHp
        : previousMaxHp;
...
function getBattleSprites() {
    const playerSprite = battleScreen.querySelector('.character-sprite[data-role="player"]');
    const opponentSprite = battleScreen.querySelector('.character-sprite[data-role="opponent"]');
    return { playerSprite, opponentSprite };
}
function animateAttack(attackerRole, defenderRole, attacker, attack, hit) {
    return new Promise((resolve) => {
        const { playerSprite, opponentSprite } = getBattleSprites();
        const attackerSprite = attackerRole === "player" ? playerSprite : opponentSprite;
        const defenderSprite = defenderRole === "player" ? playerSprite : opponentSprite;
        ...
        const battleEl = battleScreen.querySelector(".battle");
